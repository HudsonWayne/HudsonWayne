            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {/* ✅ WHATSAPP BUTTON FIXED (PINK RESTORED) */}
                  <motion.a
              ...
              >
                <div className="relative">
                  <div className="w-[340px] lg:w-[450px] h-[340px] lg:h-[450px] rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
                    <img
                      src="/download (11).jpg"
